...
public class Solution3 {
    ...
    public int numberOfArithmeticSlices(int[] A) {
        ...
        return numberOfArithmeticSlices(A, 0, A.length - 1);
    }

    private int numberOfArithmeticSlices(int[] a, int start, int end) {
        ...
        return count + numberOfArithmeticSlices(a, start + 1, end);
    }
}
